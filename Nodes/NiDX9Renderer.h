...
namespace v1_2_416
{
	...
	public:
		...
		UInt32		var874;						// 874
		NiRenderTargetGroup		*DefaultRenderTargetGroup;	// 878
		NiRenderTargetGroup		*CurrentRenderTargetGroup;	// 87C
		NiRenderTargetGroup		*CurrentScreenRenderTargetGroup;// 880
		NiTPointerMap<NiRenderTargetGroup> RenderTargetList;		// 884
		UInt32				maxRenderTargets;		// 894
		UInt8		var898;						// 898
		UInt8		var899;						// 899
		UInt16		pad89A;						// 89A
		UInt32		var89C;						// 89C
		...
		/* NIELS: added ... */
#if 0
		static Create(uiWidth, uiHeight,
                                0,
